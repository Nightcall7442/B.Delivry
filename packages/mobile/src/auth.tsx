...
export interface AuthApi {
  ...
  /** «Войти через Telegram»: returns the bot link; poll `telegramLogin` until it signs in. */
  startTelegramLogin: () => Promise<{ code: string; url: string; expiresIn: number }>;
  /** One poll: the user once the bot has done its part, null while waiting; throws when expired. */
